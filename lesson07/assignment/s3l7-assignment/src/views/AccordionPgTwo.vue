...
<!-- example code from https://medium.com/@olaysco/dynamic-list-toggling-in-vuejs-accordion-9020a5d91497 -->
  <div id="accordion-page2">
    ...
    <img class="img-fluid p-3 my-3" :src="item.src" alt="" width="225px" height="150px">
      <br>
    <a href="#" target="_blank">Learn more about {{item.name}} here if desired.</a>
    </AccordionContentTwo>
    <S3L7Footer/>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    prepareDynamicList(){
      let list = [
        {name: "yolo", age: 6, src: require('../../public/img/headshot1.jpg')},
        {name: "fomo", age: 8, src: require('../../public/img/headshot2.jpg')},
        {name: "fido", age: 5, src: require('../../public/img/headshot3.jpg')},
      ];
