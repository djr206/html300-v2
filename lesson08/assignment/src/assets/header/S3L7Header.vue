<template>
  <header class="container">
    ...
    <h1
      ...
      :user="item"
    >
      Sec3L7 Assignment: Refactor {{ item.pageName }} page
    </h1>
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <router-link class="nav-link" to="/"
              >Landing Page<span class="sr-only">(current)</span></router-link
            >
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/accordion-page"
          ...
          <li class="nav-item">
            ...
            <router-link class="nav-link" to="/accordion-page2"
              >Accordion2</router-link
            >
          </li>
        </ul>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      iconObject: {
        pageIcons: ["fa fa-bullseye fa-5x", "fa fa-film fa-5x"],
      },
